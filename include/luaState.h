...
namespace lua {
	...
	class luaState {
		private:
			...
			// Private thread registry functions
			void regthread(luaState*);
			void deregthread(luaState*);

			luaState& operator=(luaState&);							// delete function keyword not currently supported in vs2012
		public:
			...
			luaState(luaState&);									//	thread		Sets the new luaState as a thread of the passed luaState
